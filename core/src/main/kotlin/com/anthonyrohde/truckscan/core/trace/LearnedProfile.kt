...
import com.anthonyrohde.truckscan.core.ford.AsBuiltDidMap
 ...
 *    derivation algorithm, but see [com.anthonyrohde.truckscan.core.ford.SeedKeyAlgorithm.Replay].
 */
data class LearnedProfile(
    ...
    fun serialise(): String = buildString {
        appendLine("# truckscan learned profile v$FORMAT_VERSION")
