...
import com.anthonyrohde.truckscan.core.pid.GaugeZone
...
fun Gauge(pid: Pid, value: PidValue?, modifier: Modifier = Modifier) {
    when (pid.style) {
        com.anthonyrohde.truckscan.core.pid.GaugeStyle.DIAL -> DialGauge(pid, value, modifier)
        com.anthonyrohde.truckscan.core.pid.GaugeStyle.ARC -> ArcGauge(pid, value, modifier)
        com.anthonyrohde.truckscan.core.pid.GaugeStyle.BAR -> BarGauge(pid, value, modifier)
    }
}
